...
public class NameGenerator
{
  ...
  private static final String FEMALE_NAMES_FILE = "../dist.all.last.txt";

  private static final String MALE_NAMES_FILE = "../dist.female.first.txt";

  private static final String SURNAMES_FILE = "../dist.male.first.txt";
  ...
  public static void main(String args[]) throws IOException
	{
	 ...
	 //  String file = "D:/B3ds/FhirGenerator/PatientName/src/main/resources/dist.all.last.txt";
